...
def nms_modified(prediction, obj_thre = 0.5, iou_thres = 0.6, nc=256, max_det=300,classes = None):
    ...
    for xi, x in enumerate(prediction):  # image index, image inference
        ...
        #     weights = iou * nomralized_depth[None]  # box weights
...
if __name__ == "__main__":
    ...
    boxa =  torch.randint(0,255,size=(5,4))
    boxb = torch.randint(0,255,size=(5,4))
    iou = box_iou(boxa,boxb)

    boxa =  torch.randint(0,255,size=(4,))
    boxb = torch.randint(0,255,size=(6,4))
